            ...
            if (Util::if_version_higher($latestVersion, $dismissedNotificationVersion)) {
                array_push($wpNotifications, array(
                    ...
                    'propertyBag' => array(
                        ...
                        "action" => "[{\"Text\":\"" ./* translators: Update button in banner */ __("Update Now", 'microsoft-start') . "\",\"Href\":\"/wp-admin/plugins.php?s=microsoft-start\",\"IsExternalLink\":false}]"
                    )
                ));
            }
        }
            ...
            if (count($posts)) {
                array_push($wpNotifications, array(
                    ...
                    'propertyBag' => array(
                        ...
                        "action" => "[{\"Text\":\"" ./* translators: Batch submit button in banner */ __("Submit all", "microsoft-start") . "\",\"Href\":\"/wp-admin/admin.php?page=microsoft-start#/batch-submit\",\"IsExternalLink\":false},{\"Text\":\"" ./* translators: Submit button in banner */ __("Edit and submit one by one", "microsoft-start") . "\",\"Href\":\"/wp-admin/edit.php\",\"IsExternalLink\":false}]"
                    )
                ));
            }
        }
        if (Options::get_status() === 'active' && Options::get_publishOption() === 'editor' && Options::get_batch_submit_completed_notification() && ($profileFromDb->partnerMetadata->paymentStatus->stripeAccountStatus ?? null) === 1) {
            array_push($wpNotifications, array(
                ...
                'propertyBag' => array(
                    ...
                    "action" => "[{\"Text\":\"" ./* translators: View details button in banner */ __("View details", "microsoft-start") . "\",\"Href\":\"/wp-admin/admin.php?page=microsoft-start#/batch-submit\",\"IsExternalLink\":false}]"
                )
            ));
        }
