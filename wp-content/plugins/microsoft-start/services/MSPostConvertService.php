...
class MSPostConvertService
{
    public static function compose_ms_post(WP_Post $post)
    {
        ...
        if (!$msn_id) {
            ...
            $msn_id = Options::get_msn_article_id_prefix().($post->ID ?: uniqid());
        }
    ...
    public static function get_featured_img(WP_Post $post) {
        ...
        $featureImage = static::get_featured_img_url_from_post_request() ?: get_the_post_thumbnail_url($post) ?: null;
    ...
    private static function get_featured_img_url_from_post_request()
    {
        ...
        return wp_get_attachment_image_url($featured_media_id, "post-thumbnail");
    }
