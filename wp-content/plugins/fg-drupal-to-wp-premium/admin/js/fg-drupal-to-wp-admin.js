...
class fgd2wpp {
  ...
  constructor() {
    ...
    // DINKUM: Add taxonomies select and deselect.
    this.all_taxonomy_selected = false;
  }
  ...
  /**
   * DINKUM: Hide or unhide the partial tax nodes box
   */
  hide_unhide_partial_import_tax_box() {
    $("#skip_taxonomies_box").toggle(!$("#skip_taxonomies").is(':checked'));
  }
  ...
  /**
   * DINKUM: Select / deselect all taxonomy types
   *
   * @returns {Boolean}
   */
  toggle_taxonomy_types() {
    this.all_taxonomy_selected = !this.all_taxonomy_selected;
    $('#partial_import_taxonomies input').prop("checked", this.all_taxonomy_selected);
    return false;
  }
...
window.addEventListener('load', () => {
  ...
  // DINKUM: Skip tax checkbox
  $("#skip_taxonomies").bind('click', () => {
    fgd2wp.hide_unhide_partial_import_tax_box();
  });
  fgd2wp.hide_unhide_partial_import_tax_box();
  ...
  // DINKUM: Select / deselect all taxonomy types
  $('#toggle_taxonomy_types').click(() => {
    fgd2wp.toggle_taxonomy_types();
    return false;
  });
